...
int main()
{
    ...
    // No compile error b/c using same sorting criteria so same comparison
    std::map<std::string, int, WordGreaterComparator> mapOfWords_3;
    std::map<std::string, int, WordGreaterComparator> mapOfWords_4;
if(mapOfWords_3 == mapOfWords_4)
   std::cout<<"Maps are same"<<std::endl;
